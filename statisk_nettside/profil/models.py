...
class Overforing(models.Model):
    ...
    input_destinasjon_konto_nummer = models.IntegerField()                  # Sende til konto nummer
    input_mengde_for_overforing = models.IntegerField()                     # Mengde som skal sendes.

    # CharField: Maksimum character felt som kan lagres. I SQL er det varchar[mengde]
    # DateField: Egen dato class skapt i django.db [models]
    # IntegerField: En integer fra -2.14e9 til +2.14e9